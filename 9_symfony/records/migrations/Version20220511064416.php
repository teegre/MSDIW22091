 ...
 */
final class Version20220511064416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist ADD artist_img VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist DROP artist_img');
        $this->addSql('ALTER TABLE song MODIFY song_id INT NOT NULL');
